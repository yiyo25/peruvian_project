...
<script type="text/x-kendo-template" id="ventanaAlerta">
	<p>
		<strong>Esta seguro de eliminar el aspecto:</strong>
		<br/>
	...
	$(document).ready(function() {
		var grid = $('#grid').kendoGrid({
			dataSource: {
				transport: {
					read: {
						url			:	'<?php echo base_url();?>gso/listaSubCategoria/1',
						dataType	:	'json'
					}
				},
				pageSize: 12
				...
				{ command: [
					{ 	
						...
						click	: 	function(e){
										...
										$.ajax({
											type 	: 	'POST',
											url 	: 	'<?php echo base_url();?>gso/viewMantenimientoSubCategoria',
											data 	: 	cadena,
		...
		$('.k-grid-nuevo').click(function(e){
			$.ajax({
				type	:	'POST',
				url		:	'<?php echo base_url();?>gso/viewMantenimientoSubCategoria',
				data	:	'mantenimiento=Nuevo&catID=1',
				success	: 	function(data){
