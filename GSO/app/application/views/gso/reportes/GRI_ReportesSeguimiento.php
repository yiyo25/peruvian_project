	...
	$(document).ready(function() {
		$("#grid").kendoGrid({
			...
			dataSource: {
				transport: {
					read: {
						url			:	'<?php echo base_url();?>gso/listaReporte/Seguimiento',
						dataType	:	'json'
					}
				},
				schema: {
				...
				},
				{
					...
					filterable: {
						...
						dataSource: {
							transport: {
								read: {
									url: '<?php echo base_url();?>gso/filtrarReporteProceso/Seguimiento',
									dataType: "json",
									data: {
										field: "proceso"
									}
				...
				},
				{
					...
					filterable: {
						...
						dataSource: {
							transport: {
								read: {
									url: '<?php echo base_url();?>gso/filtrarReporteSubProceso/Seguimiento',
									dataType: "json",
									data: {
										field: "subProceso"
									}
				...
				{ command: [
					...
					{ 	
						...
						click	: 	function(e){
										...
										$.ajax({
											type 	: 	'POST',
											url 	: 	'<?php echo base_url();?>gso/CambiarEstadoReporte',
											data 	: 	cadena,
