    ...
    $(document).ready(function() {
        $("#grid").kendoGrid({
            ...
            dataSource: {
                transport: {
                    read: {
                        url: '<?php echo base_url();?>iosa/listaReporte/NoAtendido',
                        dataType: 'json'
                    }
                },
                schema: {
                ...
                },
                {
                    ...
                    filterable: {
                        ...
                        dataSource: {
                            transport: {
                                read: {
                                    url: '<?php echo base_url();?>iosa/filtrarReporteProceso/NoAtendido',
                                    dataType: "json",
                                    data: {
                                        field: "proceso"
                                    }
                ...
                },
                {
                    ...
                    filterable: {
                        ...
                        dataSource: {
                            transport: {
                                read: {
                                    url: '<?php echo base_url();?>iosa/filtrarReporteSubProceso/NoAtendido',
                                    dataType: "json",
                                    data: {
                                        field: "subProceso"
                                    }
                ...
                },
                {
                    command: [{
                            ...
                            click: function(e) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '<?php echo base_url();?>iosa/enviarRecordatorioRNA',
                                    data: cadena,
