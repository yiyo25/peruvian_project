	...
	$(document).ready(function() {
		$("#grid").kendoGrid({
			...
			dataSource: {
				transport: {
					read: {
						url			:	'<?php echo base_url();?>iosa/listaReporte/Seguimiento',
						dataType	:	'json'
					}
				},
				schema: {
				...
				},
				{
					...
					filterable: {
						...
						dataSource: {
							transport: {
								read: {
									url: '<?php echo base_url();?>iosa/filtrarReporteProceso/Seguimiento',
									dataType: "json",
									data: {
										field: "proceso"
									}
				...
				},
				{
					...
					filterable: {
						...
						dataSource: {
							transport: {
								read: {
									url: '<?php echo base_url();?>iosa/filtrarReporteSubProceso/Seguimiento',
									dataType: "json",
									data: {
										field: "subProceso"
									}
				...
				{ command: [
					{ 	
						...
						click	: 	function(e){
										...
										var cadena		=	'id='+dataItem.id+'&tipo=Seguimiento';
										$.ajax({
											type 	: 	'POST',
											url 	: 	'<?php echo base_url();?>iosa/viewSegumientoReporte',
											data 	: 	cadena,
					...
					{ 	
						...
						click	: 	function(e){
										var dataItem 	=	this.dataItem($(e.currentTarget).closest('tr'));
										var cadena		=	'id='+dataItem.id;
										$.ajax({
											type 	: 	'POST',
											url 	: 	'<?php echo base_url();?>iosa/CambiarEstadoReporte',
											data 	: 	cadena,
