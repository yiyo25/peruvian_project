...
multiselect('#cboAspecto','Seleccione el Aspecto','Escoja el aspecto','SubCat_Descripcion','SubCat_ID','<?php echo base_url()?>iosa/listaSubCategoria/1','');
combobox('#cboTipoReporte','Seleccione el Tipo de Reporte','SubCat_ID','SubCat_Descripcion','<?php echo base_url()?>iosa/listaSubCategoria/2','');
combobox('#cboTipoAccion','Seleccione el Tipo de Acción','SubCat_ID','SubCat_Descripcion','<?php echo base_url()?>iosa/listaSubCategoria/4','');
