	...
	$(document).ready(function() {
		$("#grid").kendoGrid({
			...
			dataSource: {
				transport: {
					read: {
						url			:	'<?php echo base_url();?>iosa/listaReporte/Terminado',
						dataType	:	'json'
					}
				},
				schema: {
				...
				},
				{
					...
					filterable: {
						...
						dataSource: {
							transport: {
								read: {
									url: '<?php echo base_url();?>iosa/filtrarReporteProceso/Terminado',
									dataType: "json",
									data: {
										field: "proceso"
									}
				...
				},
				{
					...
					filterable: {
						...
						dataSource: {
							transport: {
								read: {
									url: '<?php echo base_url();?>iosa/filtrarReporteSubProceso/Terminado',
									dataType: "json",
									data: {
										field: "subProceso"
									}
