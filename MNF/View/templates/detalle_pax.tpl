            ...
            <div class="panel-body">
                ...
                <div  class="row">
                    ...
                    <div class="col-xs-4 col-sm-2 col-md-2" >
                        <a href="{$SERVER_NAME}ES/Tuua_application/exportarExcel/{$id_file}" ><img src="{$SERVER_PUBLIC}img/excel-import.png" width="50" height="50" TITLE="exportar Excel"></a>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <table id="tblpasajeros" class="table table-hover  table-striped table-bordered">
                                ...
                                {section name=cont loop=$pasajeros}
                                    <tr {if isset($pasajeros[cont]["color"]) && $pasajeros[cont]["color"] neq "" } class="danger" {/if}>
