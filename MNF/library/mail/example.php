<?php
    ...
    */
    $mail->setFrom('NO-Reply <ventasweb@peruvianairlines.pe>');
    
	$mail->setSMTPParams('mail.peruvianairlines.pe', 25, 'mail.peruvianairlines.pe', true, 'ventasweb@peruvianairlines.pe', 'peru123');
    ...
    */
    $mail->setReceipt('ventasweb@peruvianairlines.pe');
    ...
    */
    $address = 'raul.padilla@peruvianairlines.pe';
