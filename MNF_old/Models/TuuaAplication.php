...
class TuuaAplication extends Model
{
    ...
    public function getPasajero($idItensPax){
        $pasajeros="SELECT idItensPax,nroTicketPax,apellidoPax,nombrePax,tipoPax,foidPax,destinoPax,clasePax,nroCuponPax,nroReferencia,nroAsientoPax,nroDoc,nacPax,tres,Estado FROM tuuaPasajerosFile  WHERE idItensPax=:idItensPax";
        $pasajeros= $this->executeQuery( $pasajeros,array("idItensPax"=>$idItensPax) );
        return $pasajeros;
    }
}