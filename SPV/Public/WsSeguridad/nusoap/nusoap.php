...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=65, $cookies=NULL) {
	...
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=30, $cookies) {
		...
		//echo "Mi data  https : ".$data."<br><br>";
		//echo "Mi cookies : ".$cookies;
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 15, $response_timeout = 10, $portName = ''){
		parent::nusoap_base();
	...
	*/
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		//echo "estas son mis headers : ".$headers."<br>";
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=65) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
